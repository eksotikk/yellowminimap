...
// @version      eksotik
// @description  vandalism lol
// @author       eksotik#3558
// @match        https://pixelzone.io/*
// @match        http://pixelzone.io/*
// @homepage     https://github.com/eksotikk/yellowminimap/
// @updateURL    https://raw.githubusercontent.com/eksotikk/yellowminimap/master/minimap.user.js
// @downloadURL  https://raw.githubusercontent.com/eksotikk/yellowminimap/master/minimap.user.js
// @grant        none
// ==/UserScript==
...
var range = 25;
window.baseTepmlateUrl = 'https://raw.githubusercontent.com/eksotikk/yellowminimap/master/';
...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<style>.grecaptcha-badge{display: none;}</style>   <div id="minimapbg" style="position: absolute; right: 1em; bottom: 1em;">' +
        '<div class="posy" id="posyt" style="background-color: rgba(255, 238, 0, 0.75); color: rgb(255, 255, 255); text-align: center; line-height: 30px; vertical-align: middle; width: auto; height: auto; border-radius: 0px; padding: 2px;">' +
        ...
        '<span id="hide-map" style="cursor:pointer;font-size:18px;">    Gizle' +
        ...
        '<span id="minimap-tr" style="font-weight:bold;text-align:center;"> 𝓨𝓮𝓵𝓵𝓸𝔀𝓩𝓸𝓷𝓮' +
        '</div>' +
        '</div>';
